  ...
  return (
    <div
      style={{
        ...
        background: 'linear-gradient(135deg, #FF9800 0%, #FFB74D 25%, #FFCC02 50%, #FFD54F 75%, #FFF3E0 100%)',
      ...
      >
        ...
        <h1
          style={{
            ...
            margin: '0 0 16px 0',
            fontWeight: '800',
            background: 'linear-gradient(45deg, #FF9800, #FFC107, #FFEB3B, #F57F17)',
            backgroundSize: '400% 400%',
        ...
        >
          <Link
            ...
            onMouseEnter={(e) => {
              ...
              target.style.boxShadow = '0 6px 20px rgba(255, 152, 0, 0.4)';
            }}
            onMouseLeave={(e) => {
              const target = e.currentTarget as HTMLElement;
